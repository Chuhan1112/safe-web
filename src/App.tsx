            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <p className="max-w-3xl text-sm leading-6 text-slate-300 md:text-base">
                  This build keeps the visual system, interaction patterns, and demo data,
                  while leaving private logic, endpoints, and research context behind.
                </p>
              </div>
            </div>
          ...
          <section className="space-y-6">
            ...
            <Card className="border-primary/20 bg-gradient-to-br from-primary/15 via-slate-950/80 to-slate-950/80 shadow-xl shadow-slate-950/20">
              ...
              <CardContent className="space-y-3 text-sm leading-6 text-slate-200">
                ...
                <p>Review new copy before syncing to any managed device.</p>
              </CardContent>
            </Card>
          </section>
        </main>
